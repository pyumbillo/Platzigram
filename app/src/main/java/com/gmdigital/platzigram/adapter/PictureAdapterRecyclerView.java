package com.gmdigital.platzigram.adapter;
...
import com.gmdigital.platzigram.post.view.PictureDetailActivity;
...
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public void onBindViewHolder(PictureViewHolder holder, int position) {
        ...
        holder.likeNumberCad.setText(picture.getLike_number());
    ...
    public class PictureViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView    likeNumberCad;
        ...
        public PictureViewHolder(View itemView) {
            ...
            likeNumberCad= (TextView) itemView.findViewById(R.id.likeNumberCard);
